package com.fse.membermanagement.adapter.controller;
...
import com.fse.membermanagement.application.SkillDTO;
...
private MemberManagementService memberManagementService;
	...
	public String getSkillInformationOfMember(@PathVariable Integer id) {	
		List<SkillDTO> skills = memberManagementService.readSkillsFromMember(id);
		if (skills != null) {
			if (!skills.isEmpty()) {
	...
	public List<String> getAllSkillsInformation() {	
		List<SkillDTO> sList = memberManagementService.readAllSkills();
